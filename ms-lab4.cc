 ...
 * Last update: 2020-03-18 09:28:04
 */
...
// Lab exercise: 4
// 
// This scenario allows to measure the impact of randomness on the performance of an IEEE 802.11ax Wi-Fi network 
...
NS_LOG_COMPONENT_DEFINE ("ms-lab4");
